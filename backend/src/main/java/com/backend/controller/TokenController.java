...
import com.backend.dto.TokenRequest;
...
public class TokenController {
    ...
    public String getToken(@RequestBody TokenRequest tokenRequest) {
        ...
        if (authentication.isAuthenticated()) {
            return jwtService.generateToken(tokenRequest.getUsername(), authentication.getAuthorities().toArray()[0].toString());
        }
        throw new UsernameNotFoundException("invalid username {} " + tokenRequest.getUsername());
    }
}
